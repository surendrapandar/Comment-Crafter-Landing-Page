      ...
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 mx-auto mb-16 max-w-[62rem] text-center md:mb-20 lg:mb-24">
          <h1 className="h1 mb-6">
            Make Every LinkedIn Interaction Count with&nbsp;AI&nbsp;
          ...
          <p className={cn("body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8")}>
            Generate personalized comments and messages in seconds. Save time, build relationships,
            and grow your network with AI
          </p>
          <Button href="https://forms.gle/wS8tNXPw4aMKtNiK6" white>
              ...
              >
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <Notification
                    ...
                    title="Make Relation Not Just Connections"
                  />
                </ScrollParallax>
              </div>
            </div>
