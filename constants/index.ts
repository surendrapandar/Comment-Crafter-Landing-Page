...
export const benefits = [
  {
    id: "0",
    title: "Human Emotions with AI brain",
    text: "Comment Crafter uses AI to analyze the sentiment of post and your preferences to generate personalized comments.",
  ...
  {
    id: "1",
    title: "100% Human-like comments",
    text: "Generates comments that are indistinguishable from those written by a human, making them more engaging and authentic.",
  ...
  },
  {
    ...
    text: "Meaningful comments help you build a positive reputation online which help you to grow your network.",
  ...
  {
    id: "3",
    title: "Engaging and authentic comments",
    text: "Generates comments that are engaging and authentic, helping you stand out in a crowded social media landscape.",
  ...
  },
  {
    ...
    text: "Comment Crafter is a chrome extension that can be accessed from any device, making it easy to use on the go.",
  ...
  },
  {
    ...
    text: "We are constantly improving our AI to generate more accurate and relevant comments for you.",
